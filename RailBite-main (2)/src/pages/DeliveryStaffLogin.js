...
const DeliveryStaffLogin = () => {
    ...
    useEffect(() => {
        if (isStaffAuthenticated) navigate('/delivery/dashboard');
        ...
        try {
            ...
            if (res.data.success) {
                ...
                if (user.role !== 'delivery') {
                    setToast({ message: 'Access denied. Delivery staff only.', type: 'error' });
                    triggerShake();
                    setLoading(false);
                    return;
                }
                ...
                setTimeout(() => navigate('/delivery/dashboard'), 800);
            } else {
            ...
            <div className="lg-form-panel">
                <div className="lg-form-inner">
                    ...
                    <div className={`lg-card ${shake ? 'lg-card--shake' : ''}`}>
                        <div className="lg-card__badge lg-card__badge--delivery">🚚 Delivery Staff</div>
                        <h2 className="lg-card__title">Delivery Portal</h2>
                        <p className="lg-card__sub">Sign in to manage your deliveries</p>
                        ...
                        <p className="lg-switch" style={{ marginTop: '1.25rem' }}>
                            Not delivery staff? <a href="/login">Customer Login</a>
                        </p>
                    </div>
                </div>
            </div>
