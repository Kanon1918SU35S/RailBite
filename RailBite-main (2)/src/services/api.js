...
export const trainAPI = {
  ...
  getStats: (token) =>
    axios.get(`${API_BASE_URL}/trains/stats`, {
      headers: { Authorization: `Bearer ${token}` }
    }),
  create: (data, token) =>
  ...
  toggleActive: (id, token) =>
    axios.patch(`${API_BASE_URL}/trains/${id}/toggle-active`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    }),
  delete: (id, token) =>
...
export const loyaltyAPI = {
  ...
  getUserDetails: (userId, token) =>
    axios.get(`${API_BASE_URL}/loyalty/admin/user/${userId}`, {
      headers: { Authorization: `Bearer ${token}` }
    }),
  getStats: (token) =>
    axios.get(`${API_BASE_URL}/loyalty/admin/stats`, {
      headers: { Authorization: `Bearer ${token}` }
    }),
  ...
  deductPoints: (data, token) =>
    axios.post(`${API_BASE_URL}/loyalty/admin/deduct`, data, {
      headers: { Authorization: `Bearer ${token}` }
    })
};
